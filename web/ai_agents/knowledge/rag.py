"""RAG (Retrieval Augmented Generation) engine for ReconAgent."""
...
from .distributed_rag import VectorStore
...
class RAGEngine:
    """Vector search over security knowledge."""
        ...
        Args:
            ...
            vector_store: Optional VectorStore for distributed storage
        """
    ...
    def index(self, force: bool = False):
        ...
        if chunks:
            ...
            # Sync to VectorStore if available
    ...
    def search(
        ...
        if self.vector_store:
            ...
            results_with_scores = self.vector_store.search(query_embedding, k=k)
            # Filter by threshold and budget
            results = []
            total_tokens = 0
        ...
        # Compute cosine similarities locally
