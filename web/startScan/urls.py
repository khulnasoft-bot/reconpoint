...
urlpatterns = [
    path("<slug:slug>/history/scan", views.scan_history, name="scan_history"),
    path("<slug:slug>/history/subscan", views.subscan_history, name="subscan_history"),
    path(
        "<slug:slug>/scheduled/", views.scheduled_scan_view, name="scheduled_scan_view"
    ),
    path("<slug:slug>/detail/<int:id>", views.detail_scan, name="detail_scan"),
    path("create_report/<int:id>", views.create_report, name="create_report"),
    path("<slug:slug>/all/subdomains", views.all_subdomains, name="all_subdomains"),
    path("detail/vuln/<int:id>", views.detail_vuln_scan, name="detail_vuln_scan"),
    path("<slug:slug>/detail/vuln", views.detail_vuln_scan, name="all_vulns"),
    path("visualise/<int:id>", views.visualise, name="visualise"),
    path("<slug:slug>/detail/all/endpoint", views.all_endpoints, name="all_endpoints"),
    path("<slug:slug>/start/<int:domain_id>", views.start_scan_ui, name="start_scan"),
    path(
    ...
    path("stop/scan/<str:id>", views.stop_scan, name="stop_scan"),
    path(
    ...
    path(
        "<slug:slug>/delete/multiple", views.delete_scans, name="delete_multiple_scans"
    ),
    path(
    ...
    path("<slug:slug>/stop/multiple", views.stop_scans, name="stop_multiple_scans"),
]
